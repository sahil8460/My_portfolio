const SocialIcons = () => {
  ...
  return (
    <div className="socialIcons" style={styles.socialIcons}>
      <a className="icon" style={styles.icon} href="https://github.com/sahil8460">
        <i className="fa-brands fa-github" aria-hidden="true" title="Sahil Akbari' GitHub Profile"></i>
      </a>
      <a className="icon" style={styles.icon} href="https://www.linkedin.com/in/er-sahil-akbari-510505194/">
        <i className="fa-brands fa-linkedin" aria-hidden="true" title="Sahil Akbari' LinkedIn Profile"></i>
      </a>
      <a className="icon" style={styles.icon} href="https://www.instagram.com/sahil_____91/">
